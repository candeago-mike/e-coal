...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $article = Article::create([
            ...
            <p><iframe width="100%" height="200" src="https://www.youtube.com/embed/imZTMqUB6bk" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen style="margin-top:10px; margin-bottom: 10px;"></iframe></p>
            <h2>Food to Try</h2>
        ...
        $article = Article::create([
            ...
            <p><iframe width="100%" height="200" src="https://www.youtube.com/embed/e5bK6dCokfw" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen style="margin-top:10px; margin-bottom: 10px;"></iframe></p>
            <h2>Food to Try</h2>
        ...
        $article = Article::create([
            ...
            <p><iframe width="100%" height="200" src="https://www.youtube.com/embed/PQiZNv7HOuI" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen style="margin-top:10px; margin-bottom: 10px;"></iframe></p>
            <h2>Food to Try</h2>
        ...
        $article = Article::create([
            ...
            <p><iframe width="100%" height="200" src="https://www.youtube.com/embed/YxDQKW9O4xU" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen style="margin-top:10px; margin-bottom: 10px;"></iframe></p>
            <h2>Food to Try</h2>
        ...
        $article = Article::create([
            ...
            <p><iframe width="100%" height="200" src="https://www.youtube.com/embed/Y0BeIUb2wHI" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen style="margin-top:10px; margin-bottom: 10px;"></iframe></p>
            <h2>Food to Try</h2>
